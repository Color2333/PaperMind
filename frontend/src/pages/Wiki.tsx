        ...
        <Card>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-primary/5 rounded-lg p-4 text-center">
              <p className="text-primary text-2xl font-bold">{graph.ancestors?.length || 0}</p>
              <p className="text-ink-tertiary mt-1 text-xs">引用的论文</p>
            </div>
            <div className="bg-accent/5 rounded-lg p-4 text-center">
              <p className="text-accent text-2xl font-bold">{graph.descendants?.length || 0}</p>
              <p className="text-ink-tertiary mt-1 text-xs">被引用次数</p>
            </div>
          </div>
        </Card>
      )}
