              ...
              <div className="max-h-[60vh] space-y-0.5 overflow-y-auto">
                {history.map((item) => (
                  <div
                    ...
                    className={`group flex w-full cursor-pointer items-center justify-between rounded-xl px-3 py-2.5 text-left transition-colors ${
          ...
          {!detailLoading && selectedContent && (
            <div className="animate-fade-in rounded-2xl border border-border bg-surface p-6 shadow-sm">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(selectedContent.markdown) }}
              />
            </div>
          )}
